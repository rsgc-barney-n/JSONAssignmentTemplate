    ...
    func parseMyJSON(theData : NSData) {
        ...
        do {
            ...
            if let asString = currencytextfield.text! as? String {
                ...
                if let quote : Double = Double(String(quotes!![("USD" + asString)])) {
                    
                    print("contents of money field are \(moneytextfield.text!)")
                    if let asDub = Double(moneytextfield.text!) {
                        print("contents of money field as a Double are \(asDub)")
                        
                        let convertedValue : Double = quote*asDub;
                        print("conversion is:\(convertedValue)")
                    }
